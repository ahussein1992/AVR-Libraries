 ...
 * 
 * that function return new times as "float" Variables ====>>>> fajrTime & zuhrTime & asrTime & maghribTime & ishaTime
 *
 * you can use doubleToHrMin() function to convert the time from float to Hours and minutes
 /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 * 
 * Atmega8
 * Se7S_92
...
//these variables record your location data you can modify their value as you want but make sure you are using the right values to get the right times// 
float Longitude, Latitude, TimeZone, FajrTwilight, IshaTwilight;

//record the latest location value//
uint8 O_Location;
...
////////////////////////////////////////////////////////////////////////////////////////
//////////// call this function to select your new location default is Cairo ///////////
////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
//////////// call this function to calculate all praying times ///////////
//////////////////////////////////////////////////////////////////////////
